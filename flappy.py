...
class Passaro:
    ...
    #restringir o deslocamento
        if deslocamento > 16:
            deslocamento = 16
        elif deslocamento < 0: #pular mais alto depois que começa a cair 
            deslocamento -= 2    
        ...
        #angulo do passaro
        if deslocamento < 0 or self.y < (self.altura + 50):    #animação do passaro quando cai depois da altura inicial
